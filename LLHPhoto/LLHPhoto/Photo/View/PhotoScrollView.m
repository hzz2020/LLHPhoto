...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        UITapGestureRecognizer *singleTap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(hideSelf)];
...
- (void)savePhoto:(UILongPressGestureRecognizer*)ges
{
    if (ges.state==UIGestureRecognizerStateBegan){
        if ([self.s_delegate respondsToSelector:@selector(saveImageToPhotographAlbum)]) {
            [self.s_delegate saveImageToPhotographAlbum];
        }
    }
}
